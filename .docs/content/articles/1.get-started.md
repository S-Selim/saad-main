...
# Get started with Saad

Creating a blog with Saad is a command away, as well as deploying to many platforms.
...
You can deploy Saad to any static hosting by running the following command:
...
Saad supports deploying to the following platforms with **zero configuration**:
...
You can deploy Saad to a Node server by running the following command:
